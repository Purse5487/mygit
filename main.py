...
def process_excel_files():
    ...
    count = 0  # Счетчик обработанных записей
    ...
    for row1 in sheet1.iter_rows(min_row=2, max_col=12):
        ...
        cell_col12 = row1[11].value  # Значение в 12 столбце (L)
    ...
    result_label.config(text=f"Обработано записей: {count}")  # Выводим количество обработанных записей
